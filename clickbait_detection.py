...
ngrok.set_auth_token("2RIGde3Z7gOpUm36amOR4wTNeLQ_4ABw8cqwYxvDWhFwFdgqh")

!nohup streamlit run app.py --server port 8501 &
url = ngrok.connect(port = '8501')
print(url)

ngrok.connect(port=8501, authtoken=token)

st.stop()

!npm install localtunnel

!streamlit run clickbait_detection.py &>/content/logs.txt & curl ipv4.icanhazip.com
